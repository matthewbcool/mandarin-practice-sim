...
export const drinks: MenuOption[] = [
  option("milk-tea", "奶茶", ["奶茶", "一杯奶茶"], 45),
  option("pearl-milk-tea", "珍珠奶茶", ["珍珠奶茶", "珍奶", "珍珠鮮奶茶"], 60),
  option("boba-milk-tea", "波霸奶茶", ["波霸奶茶", "波霸珍奶"], 65),
  option("oolong-milk-tea", "烏龍奶茶", ["烏龍奶茶", "烏龍鮮奶茶"], 55),
  option("black-tea-latte", "紅茶拿鐵", ["紅茶拿鐵", "紅茶鮮奶"], 65),
  option("tieguanyin-milk-tea", "鐵觀音奶茶", ["鐵觀音奶茶", "鐵觀音鮮奶茶"], 60),
  option("brown-sugar-boba-milk", "黑糖珍珠鮮奶", ["黑糖珍珠鮮奶", "黑糖珍珠牛奶"], 75),
  option("taro-milk", "芋頭鮮奶", ["芋頭鮮奶", "芋頭牛奶"], 70),
  option("matcha-latte", "抹茶拿鐵", ["抹茶拿鐵", "抹茶鮮奶"], 75),
  option("pudding-milk-tea", "布丁奶茶", ["布丁奶茶"], 65),
  option("grass-jelly-milk-tea", "仙草奶凍", ["仙草奶凍", "仙草奶茶"], 65),
  option("black-tea", "紅茶", ["紅茶", "冰紅茶"], 35),
  option("green-tea", "綠茶", ["綠茶", "茉莉綠茶"], 35),
  option("oolong-tea", "烏龍茶", ["烏龍茶", "高山烏龍"], 40),
  option("sijichun", "四季春青茶", ["四季春青茶", "四季春"], 45),
  option("wintermelon-lemon", "冬瓜檸檬", ["冬瓜檸檬", "冬瓜檸檬茶"], 50),
  option("lemon-black-tea", "檸檬紅茶", ["檸檬紅茶"], 50),
  option("passion-green-tea", "百香綠茶", ["百香綠茶", "百香果綠茶"], 55),
  option("yakult-green-tea", "多多綠茶", ["多多綠茶", "養樂多綠茶"], 55),
  option("orange-green-tea", "柳橙綠茶", ["柳橙綠茶", "柳橙青茶"], 55),
];

export const sizes: MenuOption[] = [
  option("medium", "中杯", ["中杯", "中", "普通杯"], 0),
  option("large", "大杯", ["大杯", "大", "大杯的"], 10),
];

export const sweetnessLevels: MenuOption[] = [
  option("regular-sugar", "正常糖", ["正常糖", "全糖", "正常甜"], 0),
  option("less-sugar", "少糖", ["少糖", "七分糖", "七分"], 0),
  option("half-sugar", "半糖", ["半糖", "五分糖", "五分"], 0),
  option("light-sugar", "微糖", ["微糖", "三分糖", "三分"], 0),
  option("no-sugar", "無糖", ["無糖", "不要糖", "不加糖"], 0),
];

export const iceLevels: MenuOption[] = [
  option("regular-ice", "正常冰", ["正常冰", "正常"], 0),
  option("less-ice", "少冰", ["少冰", "冰少一點"], 0),
  option("light-ice", "微冰", ["微冰", "一點冰"], 0),
  option("no-ice", "去冰", ["去冰", "不要冰", "不加冰"], 0),
  option("hot", "熱", ["熱", "熱的"], 0),
];
...
export const politePhrases = ["請問", "我要", "麻煩你", "不好意思", "謝謝", "拜託"];
